        ...
        return isCompatibleSignature ||
                (
                        (absoluteDifferenceInPosition == 0 || operationsBeforeAndAfterMatch(removedOperation, addedOperation)) &&
                                ...
                                ( /*addedOperation.getParameterTypeList().equals(removedOperation.getParameterTypeList()*/ addedOperation.getParameters().size() == removedOperation.getParameters().size())
