...
public class V8BabelNode extends BabelNode{
    //region JV8
    ...
    V8BabelNode(Object value, Function<V8Object, String> toStringFunction, String fileName) {
        this.value = value;
    ...
    public BabelNode get(String member) {
        if (v8Object != null) {
            if (v8Object.contains(member)) {
                return addChild(new V8BabelNode(v8Object.get(member), toStringFunction, this.fileName));
            } else {
    ...
    private BabelNode addChild(V8BabelNode value) {
