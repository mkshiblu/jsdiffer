...
public class ExtractFunction_d3_geo_circleLinkCircularTest extends BaseTest {
    ...
    public static void setup() {
        refactorings = new JSRefactoringMiner().detectBetweenFiles(getRootResourceDirectory() + "src1\\ExtractFunction_d3_geo_circleLinkCircular.js"
                , getRootResourceDirectory() + "src2\\ExtractFunction_d3_geo_circleLinkCircular.js");
