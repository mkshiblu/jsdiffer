...
public class ExtractFunctionUpdateLayoutTest extends BaseTest {
    ...
    public static void setup() {
        refactorings = new JSRefactoringMiner().detectBetweenFiles(getRootResourceDirectory() + "src1\\ExtractFunctionUpdateLayout.js"
                , getRootResourceDirectory() + "src2\\ExtractFunctionUpdateLayout.js");
