...
\textbf Java Based Literature: Majority of the existing tools and studies used and support only Java systems. In fact, to the best of our knowledge no other tool can detect refactorings in JavaScript ecosystem except RefDiff 2.0. Even more,  because of the nature of its detection methodology, it cannot detect method level refactorings such as rename variable.

\textbf Dependence on thresholds:
