...
Leo Brodie \cite{thinkingforth} first mentioned the word “Refactoring” in his book “Thinking Forth”, originally published in 1984. In addition to describing refactoring techniques, the author also discussed many software development principles and practices. However, It was Opdyke \cite{OPDYKE1990}  who defined refactorings as source code transformations that improves understandability and re-usability of source code.

In an early work, by Mens and Tourwe \cite{Mens2004} provided an overview of the existing research in terms of refactoring practices and techniques, refactoring tools, and the effect of refactoring on the software process. Further studies explored the impact of refactoring on quality \cite{Moser2006} \cite{wilking2007empirical} \cite{bavota2015experimental} \cite{cedrim2016does} \cite{pantiuchina2018improving} \cite{alomar2019impact}   

identifying refactoring opportunities (e.g., Fontana et al. 2012; Palomba et al. 2013), recommending
refactoring operations (e.g., Mkaouer et al. 2015; Bavota et al. 2014; Ouni et al. 2016), and
implementing refactoring tools (e.g., Roberts et al. 1997; Mazinanian et al. 2016; Kim et al.
2010; Tsantalis et al. 2018 Silva et al. 2020; Moghadam et al. 2021)
